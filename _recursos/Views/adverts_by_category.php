                                ...
                                <div class="product-item bg-light">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title"><a href="<?php echo route_to('adverts.detail', $advert->code) ?>"><?php echo $advert->title; ?></a></h4>
                                            ...
                                            <div class="product-ratings">
                                                ...
                                                <a class="btn btn-sm btn-outline-primary" href="<?php echo route_to('adverts.detail', $advert->code) ?>">Mais detalhes</a>
